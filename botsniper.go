	...
	commandHandlers = map[string]func(s *discordgo.Session, i *discordgo.InteractionCreate){
		"add-names": func(s *discordgo.Session, i *discordgo.InteractionCreate) {
			go func() {
				...
				AccountsVer = append(AccountsVer, accounts...)

				v, _ := json.MarshalIndent(jsonValues{Accounts: AccountsVer, Bearers: Confirmed, Config: ConfigsVer, Names: NamesVer, Vps: VpsesVer}, "", "  ")
		...
		"delete-names": func(s *discordgo.Session, i *discordgo.InteractionCreate) {
			go func() {
				...
				v, _ := json.MarshalIndent(jsonValues{Accounts: AccountsVer, Bearers: Confirmed, Config: ConfigsVer, Names: []string{"placeholder"}, Vps: VpsesVer}, "", "  ")
